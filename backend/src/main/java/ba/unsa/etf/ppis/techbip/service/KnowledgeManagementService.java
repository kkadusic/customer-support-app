...
public class KnowledgeManagementService {
    ...
    public Certificate getCertificate(Long id) {
        ...
        if (certificate.isEmpty())
            throw new ResourceNotFoundException("Certificate with Id = " + id + " does not exist.");
    ...
    public Response addCertificate(CertificateRequest certificateRequest) {
        ...
        if (employee.isEmpty())
            throw new ResourceNotFoundException("Employee with Id = " + certificateRequest.getEmployeeId() + " does not exist.");
    ...
    public Response editCertificate(EditCerificateRequest editCerificateRequest) {
        ...
        if (certificate.isEmpty())
            throw new ResourceNotFoundException("Certificate with Id = " + editCerificateRequest.getId() + " does not exist.");
    ...
    public Response addEducation(EducationRequest educationRequest) {
        ...
        if (employee.isEmpty())
            throw new ResourceNotFoundException("Employee with Id = " + educationRequest.getEmployeeId() + " does not exist.");
    ...
    public Response editEducation(EditEducationRequest editEducationRequest) {
        ...
        if (education.isEmpty())
            throw new ResourceNotFoundException("Education with Id = " + editEducationRequest.getId() + " does not exist.");
