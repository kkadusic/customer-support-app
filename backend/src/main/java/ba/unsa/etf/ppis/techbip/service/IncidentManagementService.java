...
public class IncidentManagementService {
    ...
    public List<Incident> getIncidents() {
        ...
        if (incidents.size() == 0) throw new ResourceNotFoundException("Incident does not exist.");
        return incidents;
    }
    ...
    public Response editIncident(EditIncidentRequest editIncidentRequest) {
        ...
        if(incident.isEmpty()) throw new ResourceNotFoundException("Incident with Id = " + editIncidentRequest.getId() + " does not exist.");
    ...
    public Response addSolution(SolutionRequest solutionRequest) {
        ...
        if(incident.isEmpty()) throw new ResourceNotFoundException("Incident with Id = " + solutionRequest.getIncidentId() + " does not exist.");

        Optional<Employee> employee = employeeRepository.findById(solutionRequest.getEmployeeId());
        if(employee.isEmpty()) throw new ResourceNotFoundException("Employee with Id = " + solutionRequest.getIncidentId() + " does not exist.");
    ...
    public Response editSolution(EditSolutionRequest editSolutionRequest) {
        ...
        if(solution.isEmpty()) throw new ResourceNotFoundException("Solution with Id = " + editSolutionRequest.getId() + " does not exist.");
    ...
    public Set<Incident> myIncidnets(Long employeeId) {
        ...
        if(employee.isEmpty()) throw new ResourceNotFoundException("Employee with Id = " + employee + " does not exist.");
