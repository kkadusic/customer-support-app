...
const ZahtjevKartica = (props) => {
    ...
    return(
        <div className="kartica">
            ...
            <button className="zahtjev-btn" onClick={()=>history.push("/prosljedjivanjezahtjeva")}>Prosljeđivanje zahtjeva</button>
            <button className="zahtjev-btn" onClick={()=>history.push("/pregledzahtjeva")}>Pregled zahtjeva</button>
        </div>
    );
}
